...
def parse_args(cross_val=False):
    ...
    parser.add_argument('--data_path', default='datasets/admet_group', type=str,
                        help='Path to datasets')
    parser.add_argument('--dataset_name', default='caco2_wang', type=str,
                        help='Name of the dataset')
    parser.add_argument('--dataset_index', default='1', type=int,
                        help='File index number')
